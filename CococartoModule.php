...
class CococartoModule extends CWebModule {

	private $_assetsUrl;

	private $_version = "v0.1.0";
	private $_versionDate = "10/01/2018";
	private $_keywords = "coco carto, pres de chez nous, module,opensource,CO,communecter";
	private $_description = "Gogo Carto module for CO";
	private $_pageTitle = "Gogo Carto modules & CO Systems";
